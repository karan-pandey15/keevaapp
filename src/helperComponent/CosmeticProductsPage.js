...
const API_URL = 'https://api.keeva.in/products/category/Beauty & wellness';
const FALLBACK_IMAGE = require("../images/grocery.png");

const CosmeticProductsPage = forwardRef((props, ref) => {
  ...
  const handleSeeAll = () => {
    navigation.navigate("CoshmeticPaeg");
  };
...
CosmeticProductsPage.displayName = "CosmeticProductsPage";
...
export default CosmeticProductsPage;
