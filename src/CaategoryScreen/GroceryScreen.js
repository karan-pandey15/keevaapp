...
const GroceryScreen = () => {
  ...
  const getItemQuantity = (id) => {
    const item = cartItems.find((item) => item.id === String(id));
  ...
  const categories = [
    { id: 1, name: 'Milk', image: vegetablePlaceholder },
    { id: 2, name: 'Breads & Buns', image: vegetablePlaceholder },
    { id: 3, name: 'Fresh Bakery', image: vegetablePlaceholder },
    { id: 4, name: 'Eggs', image: vegetablePlaceholder },
    { id: 5, name: 'Cheese', image: vegetablePlaceholder },
  ...
  const categoryProducts = {
    1: [ // Milk
      ...
      {
        id: 2,
        name: 'Amul Moti - Homogenised Toned Milk (Pouch 90 Days...',
        price: 32,
        originalPrice: null,
        quantity: '450 ml',
        rating: 4.6,
      ...
      {
        id: 3,
        name: 'Mother Dairy Double Toned Fresh Milk (Pouch)',
        price: 51,
        originalPrice: null,
        quantity: '1 L',
        rating: 4.5,
      ...
      {
        id: 4,
        name: 'Amul A2 Buffalo Fresh Milk Combo',
        price: 76,
        originalPrice: null,
        quantity: '2 x 500 ml',
        rating: 4.5,
        ...
        image: vegetablePlaceholder,
        available: true,
        badge: { pieces: '2', text: 'Pieces', brand: 'Amul' },
      },
      {
        id: 5,
        name: 'Nestle Lactogen Pro',
        price: 150,
        originalPrice: null,
        quantity: '400g',
        rating: 4.8,
  ...
  const addToCart = (product) => {
    dispatch(addItem({ ...product, id: String(product.id) }));
  };

  const increaseQuantity = (productId) => {
    dispatch(incrementQuantity(String(productId)));
  };

  const decreaseQuantity = (productId) => {
    dispatch(decrementQuantity(String(productId)));
  };
